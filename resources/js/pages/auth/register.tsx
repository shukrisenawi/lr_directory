...
export default function Register() {
    ...
    return (
        <div className="min-h-screen bg-[#eef7ff] text-[#071a3d]">
            ...
            <div className="mx-auto min-h-screen max-w-[112rem] overflow-hidden rounded-t-3xl border-t-4 border-[#073d91] bg-white shadow-[0_30px_90px_rgba(7,26,61,0.18)]">
                <header className="flex flex-col gap-5 border-b border-[#dbe8f6] bg-white px-6 py-7 sm:px-10 lg:flex-row lg:items-center lg:justify-between">
                    <Link href={route('home')} className="flex items-center gap-5">
                        <img src="/logo.svg" alt="IDXI Fisheries Directory" className="h-16 w-auto sm:h-20" />
                    </Link>
                ...
                <main className="grid min-h-[calc(100vh-14rem)] lg:grid-cols-[0.75fr_1fr]">
                    <section className="relative isolate hidden overflow-hidden bg-[#eaf6ff] lg:block">
                        ...
                        <div className="relative flex h-full flex-col justify-between px-12 py-20">
                            <div>
                            ...
                            <div className="mb-8 max-w-sm rounded-2xl bg-[#063579]/95 p-7 text-white shadow-[0_24px_70px_rgba(4,24,62,0.28)] backdrop-blur">
                    ...
                    <section className="flex items-center justify-center bg-[radial-gradient(circle_at_50%_10%,rgba(11,120,255,0.08),transparent_22rem),linear-gradient(180deg,#f6fbff_0%,#ffffff_52%,#f6fbff_100%)] px-5 py-10 sm:px-8 lg:px-16">
                        <div className="w-full max-w-3xl rounded-3xl border border-[#d8e6f6] bg-white p-7 shadow-[0_24px_80px_rgba(7,26,61,0.12)] sm:p-10 lg:p-12">
                            ...
                            <form className="mt-9 space-y-6" onSubmit={submit}>
                                <Field label="Name" error={errors.name}>
                                    <div className="relative">
                                        <User
                                            className="pointer-events-none absolute top-1/2 left-5 size-6 -translate-y-1/2 text-[#214877]"
                                            strokeWidth={1.7}
                                        />
                                        <Input
                                            id="name"
                                            ...
                                            className="h-16 rounded-lg border-[#c7d8eb] pl-16 text-lg shadow-none placeholder:text-[#7b8daa] focus-visible:ring-[#0b78ff]"
                                        />
                                    </div>
                                </Field>
                                ...
                                <Field label="Account type" error={errors.role}>
                                    <div className="relative">
                                        ...
                                        <select
                                            ...
                                            className="h-16 w-full appearance-none rounded-lg border border-[#c7d8eb] bg-white px-16 text-lg font-medium text-[#405675] shadow-none transition outline-none focus:border-[#0b78ff] focus:ring-2 focus:ring-[#0b78ff]/25"
                                        >
                                            <option value="normal">Normal User</option>
                                            <option value="company">Company</option>
                                        </select>
                                        <ChevronDown className="pointer-events-none absolute top-1/2 right-5 size-6 -translate-y-1/2 text-[#214877]" />
                                    </div>
                                </Field>
                                ...
                                <Field label="Password" error={errors.password}>
                                    <div className="relative">
                                        ...
                                        <Input
                                            ...
                                            className="h-16 rounded-lg border-[#c7d8eb] px-16 text-lg shadow-none placeholder:text-[#7b8daa] focus-visible:ring-[#0b78ff]"
                                        />
                                        <Eye
                                            className="pointer-events-none absolute top-1/2 right-5 size-6 -translate-y-1/2 text-[#214877]"
                                            strokeWidth={1.7}
                                        />
                                    </div>
                                </Field>
                                ...
                                <div className="flex items-center gap-4 rounded-lg bg-[#edf5ff] px-4 py-4 text-[#405675]">
                                    <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-white text-[#073d91] shadow-inner">
                                ...
                                <Button
                                    type="submit"
                                    className="h-16 w-full rounded-lg bg-[#075bd8] text-lg font-extrabold text-white shadow-[0_16px_35px_rgba(7,91,216,0.26)] hover:bg-[#064db8]"
                                    tabIndex={6}
                                    disabled={processing}
                                >
                                ...
                                <div className="grid gap-4 sm:grid-cols-2">
                                    <Button
                                        type="button"
                                        variant="outline"
                                        className="h-14 rounded-lg border-[#c7d8eb] text-base font-semibold text-[#405675]"
                                    >
                ...
                <footer className="border-t border-[#dbe8f6] bg-white px-6 py-8 sm:px-10">
